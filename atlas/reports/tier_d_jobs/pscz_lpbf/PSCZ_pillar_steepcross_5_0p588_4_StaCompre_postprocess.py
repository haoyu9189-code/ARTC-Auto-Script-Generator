...
odb_filename = 'PSCZ_pillar_steepcross_5_0p588_4_StaCompre.odb'
lck_filename = 'PSCZ_pillar_steepcross_5_0p588_4_StaCompre.lck'
...
try:
    ...
    if force_var is None or disp_var is None:
        ...
        with open('feature_data.txt', 'w') as f:
            f.write('PSCZ_pillar_steepcross_5_0p588_4_StaCompre' + "\n")
