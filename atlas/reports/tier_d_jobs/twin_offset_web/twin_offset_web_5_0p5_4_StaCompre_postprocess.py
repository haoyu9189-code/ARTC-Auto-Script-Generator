...
odb_filename = 'twin_offset_web_5_0p5_4_StaCompre.odb'
lck_filename = 'twin_offset_web_5_0p5_4_StaCompre.lck'
...
try:
    ...
    if force_var is None or disp_var is None:
        ...
        with open('feature_data.txt', 'w') as f:
            f.write('twin_offset_web_5_0p5_4_StaCompre' + "\n")
    ...
    os.chdir(r"D:\ARTC\ARTC-Auto-Script\atlas\reports\tier_d_jobs\twin_offset_web")
