# -*- coding: utf-8 -*-
# Abaqus post-processing script - Array mode (1x1x1)
from abaqus import *
...
print("="*80)
print("POST-PROCESSING SCRIPT STARTED (ARRAY MODE 1x1x1)")
print("Strain length (normalization): 5.0")
print("Stress area   (normalization): 25.0")
print("="*80)

script_dir = os.getcwd()
print("Working directory:", script_dir)

odb_filename = 'dual_column_web_5_0p5_4_DynaCompre_25.odb'
lck_filename = 'dual_column_web_5_0p5_4_DynaCompre_25.lck'
...
try:
    ...
    if force_var is None or disp_var is None:
        ...
        with open('feature_data.txt', 'w') as f:
            f.write('dual_column_web_5_0p5_4_DynaCompre_25' + "\n")
            f.write("status: no_outputs\n")
            f.write("strain_length: 5.0\n")
            f.write("stress_area: 25.0\n")
    ...
    os.chdir(r"D:\ARTC\ARTC-Auto-Script\atlas\reports\tierd_crush\dual_column_web_halfv")
