# -*- coding: utf-8 -*-
# Abaqus post-processing script - Array mode (1x3x1)
from abaqus import *
...
print("="*80)
print("POST-PROCESSING SCRIPT STARTED (ARRAY MODE 1x3x1)")
...
odb_filename = 'dual_column_web_5_0p5_4_DynaCompre_30_1x3x1.odb'
lck_filename = 'dual_column_web_5_0p5_4_DynaCompre_30_1x3x1.lck'
...
try:
    ...
    if force_var is None or disp_var is None:
        ...
        with open('feature_data.txt', 'w') as f:
            f.write('dual_column_web_5_0p5_4_DynaCompre_30_1x3x1' + "\n")
    ...
    os.chdir(r"D:\ARTC\ARTC-Auto-Script\atlas\reports\tierd_crush\dual_column_web_n3y_halfv")
